...
func resourceInfrastructureSSHKey() *schema.Resource {
	return &schema.Resource{
		Create:   resourceInfrastructureSSHKeyCreate,
		Read:     resourceInfrastructureSSHKeyRead,
		Update:   resourceInfrastructureSSHKeyUpdate,
		Delete:   resourceInfrastructureSSHKeyDelete,
		Exists:   resourceInfrastructureSSHKeyExists,
...
func resourceInfrastructureSSHKeyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceInfrastructureSSHKeyRead(d, meta)
}
