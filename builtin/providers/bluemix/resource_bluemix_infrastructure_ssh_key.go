...
func resourceBluemixInfrastructureSSHKey() *schema.Resource {
	return &schema.Resource{
		Create:   resourceBluemixInfrastructureSSHKeyCreate,
		Read:     resourceBluemixInfrastructureSSHKeyRead,
		Update:   resourceBluemixInfrastructureSSHKeyUpdate,
		Delete:   resourceBluemixInfrastructureSSHKeyDelete,
		Exists:   resourceBluemixInfrastructureSSHKeyExists,
...
func resourceBluemixInfrastructureSSHKeyCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceBluemixInfrastructureSSHKeyRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ProviderConfig).SoftLayerSession()
	service := services.GetSecuritySshKeyService(sess)
...
func resourceBluemixInfrastructureSSHKeyUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ProviderConfig).SoftLayerSession()
	service := services.GetSecuritySshKeyService(sess)
...
func resourceBluemixInfrastructureSSHKeyDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ProviderConfig).SoftLayerSession()
	service := services.GetSecuritySshKeyService(sess)
...
func resourceBluemixInfrastructureSSHKeyExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ProviderConfig).SoftLayerSession()
	service := services.GetSecuritySshKeyService(sess)
