...
func dataSourceBluemixInfrastructureSSHKey() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceBluemixInfrastructureSSHKeyRead,
...
func dataSourceBluemixInfrastructureSSHKeyRead(d *schema.ResourceData, meta interface{}) error {
