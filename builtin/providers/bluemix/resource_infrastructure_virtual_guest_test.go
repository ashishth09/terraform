...
func TestAccSoftLayerVirtualGuest_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:  testAccCheckSoftLayerVirtualGuestConfigBasic,
				Destroy: false,
			...
			{
				Config:  testAccCheckSoftLayerVirtualGuestConfigUpdate,
				Destroy: false,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSoftLayerVirtualGuestExists("softlayer_virtual_guest.terraform-acceptance-test-1", &guest),
					resource.TestCheckResourceAttr(
			...
			{
				Config: testAccCheckSoftLayerVirtualGuestConfigUpgradeCoresMemoryNetworkSpeed,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSoftLayerVirtualGuestExists("softlayer_virtual_guest.terraform-acceptance-test-1", &guest),
					resource.TestCheckResourceAttr(
...
func TestAccSoftLayerVirtualGuest_BlockDeviceTemplateGroup(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSoftLayerVirtualGuestConfigBlockDeviceTemplateGroup,
				Check: resource.ComposeTestCheckFunc(
...
func TestAccSoftLayerVirtualGuest_CustomImageMultipleDisks(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSoftLayerVirtualGuestConfigCustomImageMultipleDisks,
				Check: resource.ComposeTestCheckFunc(
					// image_id value is hardcoded. If it's valid then virtual guest will be created well
...
func TestAccSoftLayerVirtualGuest_postInstallScriptUri(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSoftLayerVirtualGuestConfigPostInstallScriptURI,
				Check: resource.ComposeTestCheckFunc(
					// image_id value is hardcoded. If it's valid then virtual guest will be created well
...
const testAccCheckSoftLayerVirtualGuestConfigBasic = `
...
const testAccCheckSoftLayerVirtualGuestConfigUpdate = `
resource "softlayer_virtual_guest" "terraform-acceptance-test-1" {
    hostname = "terraform-test"
    domain = "bar.example.com"
    os_reference_code = "DEBIAN_7_64"
...
const testAccCheckSoftLayerVirtualGuestConfigUpgradeCoresMemoryNetworkSpeed = `
resource "softlayer_virtual_guest" "terraform-acceptance-test-1" {
    hostname = "terraform-test"
    domain = "bar.example.com"
    os_reference_code = "DEBIAN_7_64"
...
const testAccCheckSoftLayerVirtualGuestConfigPostInstallScriptURI = `
...
const testAccCheckSoftLayerVirtualGuestConfigBlockDeviceTemplateGroup = `
...
const testAccCheckSoftLayerVirtualGuestConfigCustomImageMultipleDisks = `
