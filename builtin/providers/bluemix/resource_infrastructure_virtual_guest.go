...
func resourceInfrastructureVirtualGuest() *schema.Resource {
	return &schema.Resource{
		Create:   resourceInfrastructureVirtualGuestCreate,
		Read:     resourceInfrastructureVirtualGuestRead,
		Update:   resourceInfrastructureVirtualGuestUpdate,
		Delete:   resourceInfrastructureVirtualGuestDelete,
		Exists:   resourceInfrastructureVirtualGuestExists,
...
func getVirtualGuestTemplateFromResourceData(d *schema.ResourceData, meta interface{}) (datatypes.Virtual_Guest, error) {
	...
	if networkSpeed == 0 {
		networkSpeed = resourceInfrastructureVirtualGuest().Schema["network_speed"].Default.(int)
	}
...
func resourceInfrastructureVirtualGuestCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceInfrastructureVirtualGuestRead(d, meta)
}
