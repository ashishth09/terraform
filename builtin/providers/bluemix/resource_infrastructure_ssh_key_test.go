...
func TestAccSoftLayerSSHKey_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSoftLayerSSHKeyConfigBasic,
			...
			{
				Config: testAccCheckSoftLayerSSHKeyConfigUpdated,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSoftLayerSSHKeyExists("softlayer_ssh_key.testacc_foobar", &key),
					resource.TestCheckResourceAttr(
...
var testAccCheckSoftLayerSSHKeyConfigBasic = fmt.Sprintf(`
...
var testAccCheckSoftLayerSSHKeyConfigUpdated = fmt.Sprintf(`
resource "softlayer_ssh_key" "testacc_foobar" {
    label = "changed_name"
    notes = "changed_note"
    public_key = "%s"
